...
class FooterComponent {
	...
	add(e) {
		e.preventDefault();
		console.log(state.fieldInputValue);
		state.fieldInputValue = "";
		console.log(state.fieldInputValue);
	...
	view() {
		return m("footer", {class:"footer"}, 
					m("form", {class:"footer__wrapper","data-action":"add"},
						[
							m("div", {class:"form-box"},
								[
									m("input", {class:"form-box__input",type:"text",placeholder:"add todo...",value: state.fieldInputValue}),
